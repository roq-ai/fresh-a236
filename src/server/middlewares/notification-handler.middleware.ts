...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Course Creation.create': {
    roles: ['administrator', 'nutrition-specialist', 'meal-plan-creator'],
    key: 'Course ID',
    tenantPath: [],
    userPath: [],
  },
  'Meal Plan Update.update': {
    roles: ['administrator', 'nutrition-specialist', 'course-instructor'],
    key: 'Meal Plan ID',
    tenantPath: [],
    userPath: [],
  },
  'Nutrition Plan Deletion.delete': {
    roles: ['administrator', 'meal-plan-creator', 'course-instructor'],
